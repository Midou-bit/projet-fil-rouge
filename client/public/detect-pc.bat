...
REM
REM   Adresse publique de FrameForge : le resultat s'ouvre directement
REM   sur la page Verificateur du site deploye.
REM ================================================================
set "SITE=https://frameforge-build.netlify.app"
echo.
